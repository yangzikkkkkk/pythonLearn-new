...
df1=pd.read_excel('/Users/yangzi/Library/CloudStorage/Dropbox/云迹科技-Work/18 Temporary&Important/尚美存量酒店-品牌-省份.xlsx')
df2=pd.read_excel('/Users/yangzi/Library/CloudStorage/Dropbox/云迹科技-Work/18 Temporary&Important/尚美已经部署机器人的酒店-品牌-省份.xlsx')
print(df1.head(10))
print(df2.head(20))
...
df_merge.to_excel('/Users/yangzi/Downloads/尚美存量酒店占有率(存量客户在左关联上线机器人的酒店名单).xlsx')
